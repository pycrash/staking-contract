//** IPAD Staking Contract */
//** Author pycrash & undertaker */
...
contract Staking is Ownable, InterestHelper, IStaking {
        ...
        returns (uint16 multi)
    {
        ...
        if (
            nft.active &&
            ownsCorrectNFT(_addr, _pid) &&
            _addr != compounderContract
        ) {
        ...
        returns (uint256 value)
    {
        ...
        if (from < to) {
            ...
            value = (accrueInterest(user.totalInvested, rayValue, to.sub(from)))
